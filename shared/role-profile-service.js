...
export const ROLE_PROFILES = [
  ...
  },
  {
    ...
    domain: 'data_science',
    aliases: ['data analyst', 'business analyst', 'analytics engineer', 'data scientist', 'bi analyst', 'reporting analyst'],
    titlePatterns: [/\bdata\s+analyst\b/i, /\bbusiness\s+analyst\b/i, /\banalytics?\s+engineer\b/i, /\bdata\s+scientist\b/i, /\bbi\s+analyst\b/i],
