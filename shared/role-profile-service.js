...
export const ROLE_PROFILES = [
  ...
  },
  {
    ...
    evidencePatterns: [/\bforecast/i, /\bbudget/i, /\bfinancial\b/i, /\bvariance\b/i, /\breport/i, /\baccount/i, /\bcontrol/i, /\breconciliation\b/i, /\bmonth[- ]end\b/i, /\bgaap\b|\bifrs\b/i],
    riskClaims: ['CPA', 'ACCA', 'statutory accounts ownership', 'audit ownership', 'P&L ownership', 'tax compliance', 'forecast accuracy improvements'],
  ...
  },
  {
    ...
    credibilitySignals: ['process improvement', 'delivery planning', 'risk management', 'stakeholder coordination', 'resource planning', 'operational reporting', 'milestone tracking'],
    evidencePatterns: [
      /\bprocess\b/i,
      /\bproject\b/i,
      /\bdelivery\b/i,
