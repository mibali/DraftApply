...
export class MemoryAdmissionStore {
  constructor({
    ...
    maxConcurrentPerSubject = 1, maxRequestsPerSubject = 20, maxTokensPerSubject = 100_000,
    maxSpendMicrosPerSubject = 250_000,
  } = {}) {
    this.limits = {
...
export class RedisAdmissionStore {
  constructor(client, {
    ...
    maxTokensPerSubject = 100_000, maxSpendMicrosPerSubject = 250_000,
